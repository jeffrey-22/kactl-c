...
\section{Network flow}
	...
	\kactlimport{MinCostMaxFlowFast.h}
...
\section{Trees}
	...
	Vertex $u$ is a centroid iff size of all subtress after removing $u$ is $\leq \frac{n}{2}$. There can be at most two centroids, and if there are two they are equivalent.

	Find a centroid, process all the contributions that go through it, delete the centroid from the graph, recursively solve for each subgraph.
